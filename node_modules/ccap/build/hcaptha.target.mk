...
INCS_Debug := \
	-I/root/.node-gyp/5.0.0/include/node \
	-I/root/.node-gyp/5.0.0/src \
	-I/root/.node-gyp/5.0.0/deps/uv/include \
	-I/root/.node-gyp/5.0.0/deps/v8/include \
...
$(obj).target/hcaptha.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(obj).target/hcaptha.node: LIBS := $(LIBS)
$(obj).target/hcaptha.node: TOOLSET := $(TOOLSET)
$(obj).target/hcaptha.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(obj).target/hcaptha.node
# Add target alias
.PHONY: hcaptha
...
$(builddir)/hcaptha.node: $(obj).target/hcaptha.node FORCE_DO_CMD
	$(call do_cmd,copy)

all_deps += $(builddir)/hcaptha.node
# Short alias for building this executable.
.PHONY: hcaptha.node
hcaptha.node: $(obj).target/hcaptha.node $(builddir)/hcaptha.node
